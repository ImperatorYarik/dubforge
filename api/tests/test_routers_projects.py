...
class TestCreateProject:
    def test_success(self, client):
        with (
            ...
            patch("app.routers.projects.projects_repo") as mock_crud,
            ...
            response = client.post(
                "/projects/create?youtube_url=https://youtube.com/watch?v=test&download_from_youtube=false"
            )
    ...
    def test_creates_folder_for_project(self, client):
        with (
            ...
            client.post("/projects/create?youtube_url=https://youtube.com/watch?v=test&download_from_youtube=false")
...
class TestListProjects:
    def test_empty_list(self, client):
        with patch("app.routers.projects.projects_repo") as mock_crud:
